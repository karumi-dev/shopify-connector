...
return [
    ...
    'shopify' => [
        ...
        'credential' => [
            ...
            'decrypt-warning'  => 'Vos identifiants Shopify n\'ont pas pu être déchiffrés (la APP_KEY a peut-être changé). Veuillez ressaisir vos identifiants et enregistrer.',
            're-enter-required' => 'Vos identifiants stockés ne peuvent pas être déchiffrés. Veuillez ressaisir la valeur.',
            'index'          => [
                ...
                'clientId'              => 'ID client',
                'clientIdPlaceholder'   => 'Entrez votre ID client',
                'clientSecret'          => 'Secret client',
                'clientSecretPlaceholder' => 'Entrez votre secret client',
