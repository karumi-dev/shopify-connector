...
return [
    ...
    'shopify' => [
        ...
        'credential' => [
            ...
            'decrypt-warning'  => 'आपके Shopify क्रेडेंशियल्स डिक्रिप्ट नहीं हो सके (APP_KEY बदल गई होगी)। कृपया अपने क्रेडेंशियल्स पुनः दर्ज करें और सहेजें।',
            're-enter-required' => 'संग्रहीत क्रेडेंशियल्स डिक्रिप्ट नहीं हो सकते। कृपया मान पुनः दर्ज करें।',
            'index'          => [
                ...
                'authAccessToken'         => 'Access Token (Custom App)',
                'authClientCredentials'   => 'Client Credentials (Organization App)',
                'accessToken'             => 'Admin API Access Token',
                'accessTokenPlaceholder'  => 'Enter your Access Token (shpat_xxxxx)',
                'clientId'              => 'क्लाइंट आईडी',
                'clientIdPlaceholder'   => 'अपना क्लाइंट आईडी दर्ज करें',
                'clientSecret'          => 'क्लाइंट सीक्रेट',
                'clientSecretPlaceholder' => 'अपना क्लाइंट सीक्रेट दर्ज करें',
