...
return [
    ...
    'shopify' => [
        ...
        'credential' => [
            ...
            'decrypt-warning'  => 'تعذّر فك تشفير بيانات اعتماد Shopify (ربما تغيّر APP_KEY). يرجى إعادة إدخال بيانات الاعتماد والحفظ.',
            're-enter-required' => 'لا يمكن فك تشفير بيانات الاعتماد المخزّنة. يرجى إدخال القيمة مجدداً.',
            'index'          => [
