...
return [
    ...
    'shopify' => [
        ...
        'credential' => [
            ...
            'decrypt-warning'  => 'Не удалось расшифровать учётные данные Shopify (возможно, изменился APP_KEY). Пожалуйста, введите учётные данные повторно и сохраните.',
            're-enter-required' => 'Сохранённые учётные данные не удаётся расшифровать. Введите значение заново.',
            'index'          => [
