...
return [
    ...
    'shopify' => [
        ...
        'credential' => [
            ...
            'decrypt-warning'  => 'Your Shopify credentials could not be decrypted (the APP_KEY may have changed). Please re-enter your credentials below and save.',
            're-enter-required' => 'Your stored credentials cannot be decrypted. Please enter the value again.',
            'index'          => [
